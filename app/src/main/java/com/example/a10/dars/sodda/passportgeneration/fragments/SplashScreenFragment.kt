...
import com.example.a10.dars.sodda.passportgeneration.databinding.FragmentSplashScreenBinding
...
class SplashScreenFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        binding.apply {
            ...
            looper.postDelayed({ findNavController().navigate(R.id.menuFragment) }, 500)
        }
        return binding.root
    }
